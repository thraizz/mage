...
func init() {
	cards.Register("Arcane Flight", NewArcaneFlight)
}

// NewArcaneFlight creates a Arcane Flight
// {U} - ENCHANTMENT
func NewArcaneFlight(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Arcane Flight")
	card.ManaCost = "{U}"
