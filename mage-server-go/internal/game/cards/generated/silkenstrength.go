...
func init() {
	cards.Register("Silken Strength", NewSilkenStrength)
}

// NewSilkenStrength creates a Silken Strength
// {1}{G} - ENCHANTMENT
// Flash
func NewSilkenStrength(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Silken Strength")
	card.ManaCost = "{1}{G}"
