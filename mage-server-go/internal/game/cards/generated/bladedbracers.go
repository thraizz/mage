...
func init() {
	cards.Register("Bladed Bracers", NewBladedBracers)
}

// NewBladedBracers creates a Bladed Bracers
// {1} - ARTIFACT
func NewBladedBracers(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Bladed Bracers")
	card.ManaCost = "{1}"
