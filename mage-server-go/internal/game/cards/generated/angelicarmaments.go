...
func init() {
	cards.Register("Angelic Armaments", NewAngelicArmaments)
}

// NewAngelicArmaments creates a Angelic Armaments
// {3} - ARTIFACT
func NewAngelicArmaments(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Angelic Armaments")
	card.ManaCost = "{3}"
