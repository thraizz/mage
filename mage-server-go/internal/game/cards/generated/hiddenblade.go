...
func init() {
	cards.Register("Hidden Blade", NewHiddenBlade)
}

// NewHiddenBlade creates a Hidden Blade
// {2} - ARTIFACT
// Flash
func NewHiddenBlade(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Hidden Blade")
	card.ManaCost = "{2}"
