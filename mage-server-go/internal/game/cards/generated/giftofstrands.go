...
func init() {
	cards.Register("Gift Of Strands", NewGiftOfStrands)
}

// NewGiftOfStrands creates a Gift Of Strands
// {3}{G} - ENCHANTMENT
// Flash
func NewGiftOfStrands(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Gift Of Strands")
	card.ManaCost = "{3}{G}"
