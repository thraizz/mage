...
func init() {
	cards.Register("Fuss Bother", NewFussBother)
}

// NewFussBother creates a Fuss Bother
// {2}{R/W} - INSTANT
func NewFussBother(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Fuss Bother")
	card.ManaCost = "{2}{R/W}"
