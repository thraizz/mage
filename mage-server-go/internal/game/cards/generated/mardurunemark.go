...
func init() {
	cards.Register("Mardu Runemark", NewMarduRunemark)
}

// NewMarduRunemark creates a Mardu Runemark
// {2}{R} - ENCHANTMENT
func NewMarduRunemark(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Mardu Runemark")
	card.ManaCost = "{2}{R}"
