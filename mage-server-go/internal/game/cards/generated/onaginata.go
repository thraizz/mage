...
func init() {
	cards.Register("O Naginata", NewONaginata)
}

// NewONaginata creates a O Naginata
// {1} - ARTIFACT
func NewONaginata(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "O Naginata")
	card.ManaCost = "{1}"
