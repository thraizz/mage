...
func init() {
	cards.Register("Leaden Fists", NewLeadenFists)
}

// NewLeadenFists creates a Leaden Fists
// {2}{U} - ENCHANTMENT
// Flash
func NewLeadenFists(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Leaden Fists")
	card.ManaCost = "{2}{U}"
