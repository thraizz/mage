...
func init() {
	cards.Register("Rousing Read", NewRousingRead)
}

// NewRousingRead creates a Rousing Read
// {2}{U} - ENCHANTMENT
func NewRousingRead(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Rousing Read")
	card.ManaCost = "{2}{U}"
