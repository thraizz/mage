...
func init() {
	cards.Register("Wingspan Stride", NewWingspanStride)
}

// NewWingspanStride creates a Wingspan Stride
// {U} - ENCHANTMENT
func NewWingspanStride(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Wingspan Stride")
	card.ManaCost = "{U}"
