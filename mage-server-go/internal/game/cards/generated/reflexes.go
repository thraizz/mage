...
func init() {
	cards.Register("Reflexes", NewReflexes)
}

// NewReflexes creates a Reflexes
// {R} - ENCHANTMENT
func NewReflexes(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Reflexes")
	card.ManaCost = "{R}"
