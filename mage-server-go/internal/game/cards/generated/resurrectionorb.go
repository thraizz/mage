...
func init() {
	cards.Register("Resurrection Orb", NewResurrectionOrb)
}

// NewResurrectionOrb creates a Resurrection Orb
// {2} - ARTIFACT
func NewResurrectionOrb(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Resurrection Orb")
	card.ManaCost = "{2}"
