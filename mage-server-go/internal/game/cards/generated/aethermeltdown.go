...
func init() {
	cards.Register("Aether Meltdown", NewAetherMeltdown)
}

// NewAetherMeltdown creates a Aether Meltdown
// {1}{U} - ENCHANTMENT
// Flash
func NewAetherMeltdown(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Aether Meltdown")
	card.ManaCost = "{1}{U}"
