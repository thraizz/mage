...
func init() {
	cards.Register("Solid Footing", NewSolidFooting)
}

// NewSolidFooting creates a Solid Footing
// {W} - ENCHANTMENT
// Flash, Vigilance
func NewSolidFooting(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Solid Footing")
	card.ManaCost = "{W}"
