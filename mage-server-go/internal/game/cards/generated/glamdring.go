...
func init() {
	cards.Register("Glamdring", NewGlamdring)
}

// NewGlamdring creates a Glamdring
// {2} - ARTIFACT
func NewGlamdring(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Glamdring")
	card.ManaCost = "{2}"
