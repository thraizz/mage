...
func init() {
	cards.Register("Reach For The Sky", NewReachForTheSky)
}

// NewReachForTheSky creates a Reach For The Sky
// {3}{G} - ENCHANTMENT
// Flash
func NewReachForTheSky(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Reach For The Sky")
	card.ManaCost = "{3}{G}"
