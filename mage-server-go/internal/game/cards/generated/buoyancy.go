...
func init() {
	cards.Register("Buoyancy", NewBuoyancy)
}

// NewBuoyancy creates a Buoyancy
// {1}{U} - ENCHANTMENT
// Flash
func NewBuoyancy(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Buoyancy")
	card.ManaCost = "{1}{U}"
