...
func init() {
	cards.Register("Tiger Claws", NewTigerClaws)
}

// NewTigerClaws creates a Tiger Claws
// {2}{G} - ENCHANTMENT
// Flash
func NewTigerClaws(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Tiger Claws")
	card.ManaCost = "{2}{G}"
