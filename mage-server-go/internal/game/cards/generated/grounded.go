...
func init() {
	cards.Register("Grounded", NewGrounded)
}

// NewGrounded creates a Grounded
// {1}{G} - ENCHANTMENT
// Flying
func NewGrounded(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Grounded")
	card.ManaCost = "{1}{G}"
