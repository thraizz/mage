...
func init() {
	cards.Register("Mystic Subdual", NewMysticSubdual)
}

// NewMysticSubdual creates a Mystic Subdual
// {1}{U} - ENCHANTMENT
// Flash
func NewMysticSubdual(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Mystic Subdual")
	card.ManaCost = "{1}{U}"
