...
func init() {
	cards.Register("Spell Queller", NewSpellQueller)
}

// NewSpellQueller creates a Spell Queller
// {1}{W}{U} - CREATURE
// Flash, Flying
func NewSpellQueller(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Spell Queller")
	card.ManaCost = "{1}{W}{U}"
	...
	//   - Effect: SpellQuellerEntersEffect()
	//
	// Targets:
	...
	//   - Effect: SpellQuellerLeavesEffect()
