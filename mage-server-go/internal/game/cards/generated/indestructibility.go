...
func init() {
	cards.Register("Indestructibility", NewIndestructibility)
}

// NewIndestructibility creates a Indestructibility
// {3}{W} - ENCHANTMENT
func NewIndestructibility(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Indestructibility")
	card.ManaCost = "{3}{W}"
