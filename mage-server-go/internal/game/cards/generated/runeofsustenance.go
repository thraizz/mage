...
func init() {
	cards.Register("Rune Of Sustenance", NewRuneOfSustenance)
}

// NewRuneOfSustenance creates a Rune Of Sustenance
// {1}{W} - ENCHANTMENT
func NewRuneOfSustenance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Rune Of Sustenance")
	card.ManaCost = "{1}{W}"
	card.Types = []string{"ENCHANTMENT"}
	card.Subtypes = []string{"AURA", "RUNE"}
	card.SetCode = "M21"
	card.Rarity = "common"
