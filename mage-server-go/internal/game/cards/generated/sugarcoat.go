...
func init() {
	cards.Register("Sugar Coat", NewSugarCoat)
}

// NewSugarCoat creates a Sugar Coat
// {2}{U} - ENCHANTMENT
// Flash
func NewSugarCoat(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Sugar Coat")
	card.ManaCost = "{2}{U}"
