...
func init() {
	cards.Register("Rune Of Speed", NewRuneOfSpeed)
}

// NewRuneOfSpeed creates a Rune Of Speed
// {1}{R} - ENCHANTMENT
func NewRuneOfSpeed(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Rune Of Speed")
	card.ManaCost = "{1}{R}"
