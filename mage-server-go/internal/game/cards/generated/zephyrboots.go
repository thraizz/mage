...
func init() {
	cards.Register("Zephyr Boots", NewZephyrBoots)
}

// NewZephyrBoots creates a Zephyr Boots
// {1} - ARTIFACT
func NewZephyrBoots(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Zephyr Boots")
	card.ManaCost = "{1}"
