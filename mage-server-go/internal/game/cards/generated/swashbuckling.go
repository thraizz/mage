...
func init() {
	cards.Register("Swashbuckling", NewSwashbuckling)
}

// NewSwashbuckling creates a Swashbuckling
// {1}{R} - ENCHANTMENT
func NewSwashbuckling(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Swashbuckling")
	card.ManaCost = "{1}{R}"
