...
func init() {
	cards.Register("Utopia Vow", NewUtopiaVow)
}

// NewUtopiaVow creates a Utopia Vow
// {1}{G} - ENCHANTMENT
func NewUtopiaVow(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Utopia Vow")
	card.ManaCost = "{1}{G}"
