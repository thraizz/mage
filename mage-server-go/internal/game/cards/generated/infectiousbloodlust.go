...
func init() {
	cards.Register("Infectious Bloodlust", NewInfectiousBloodlust)
}

// NewInfectiousBloodlust creates a Infectious Bloodlust
// {1}{R} - ENCHANTMENT
func NewInfectiousBloodlust(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Infectious Bloodlust")
	card.ManaCost = "{1}{R}"
