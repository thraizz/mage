...
func init() {
	cards.Register("Demonic Counsel", NewDemonicCounsel)
}

// NewDemonicCounsel creates a Demonic Counsel
// {1}{B} - SORCERY
func NewDemonicCounsel(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Demonic Counsel")
	card.ManaCost = "{1}{B}"
