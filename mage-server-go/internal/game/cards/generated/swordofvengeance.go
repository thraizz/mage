...
func init() {
	cards.Register("Sword Of Vengeance", NewSwordOfVengeance)
}

// NewSwordOfVengeance creates a Sword Of Vengeance
// {3} - ARTIFACT
func NewSwordOfVengeance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Sword Of Vengeance")
	card.ManaCost = "{3}"
