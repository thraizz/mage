...
func init() {
	cards.Register("Knife", NewKnife)
}

// NewKnife creates a Knife
// {R} - ARTIFACT
func NewKnife(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Knife")
	card.ManaCost = "{R}"
