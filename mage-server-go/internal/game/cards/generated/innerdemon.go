...
func init() {
	cards.Register("Inner Demon", NewInnerDemon)
}

// NewInnerDemon creates a Inner Demon
// {2}{B}{B} - ENCHANTMENT
func NewInnerDemon(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Inner Demon")
	card.ManaCost = "{2}{B}{B}"
