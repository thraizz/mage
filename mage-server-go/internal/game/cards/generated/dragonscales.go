...
func init() {
	cards.Register("Dragon Scales", NewDragonScales)
}

// NewDragonScales creates a Dragon Scales
// {1}{W} - ENCHANTMENT
func NewDragonScales(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Dragon Scales")
	card.ManaCost = "{1}{W}"
