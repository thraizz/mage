...
func init() {
	cards.Register("Spirit Away", NewSpiritAway)
}

// NewSpiritAway creates a Spirit Away
// {5}{U}{U} - ENCHANTMENT
func NewSpiritAway(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Spirit Away")
	card.ManaCost = "{5}{U}{U}"
