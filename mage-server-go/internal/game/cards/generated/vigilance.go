...
func init() {
	cards.Register("Vigilance", NewVigilance)
}

// NewVigilance creates a Vigilance
// {W} - ENCHANTMENT
func NewVigilance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Vigilance")
	card.ManaCost = "{W}"
