...
func init() {
	cards.Register("Gigantiform", NewGigantiform)
}

// NewGigantiform creates a Gigantiform
// {3}{G}{G} - ENCHANTMENT
func NewGigantiform(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Gigantiform")
	card.ManaCost = "{3}{G}{G}"
