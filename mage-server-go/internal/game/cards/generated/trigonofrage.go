...
func init() {
	cards.Register("Trigon Of Rage", NewTrigonOfRage)
}

// NewTrigonOfRage creates a Trigon Of Rage
// {2} - ARTIFACT
func NewTrigonOfRage(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Trigon Of Rage")
	card.ManaCost = "{2}"
