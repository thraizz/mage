...
func init() {
	cards.Register("Hunters Blowgun", NewHuntersBlowgun)
}

// NewHuntersBlowgun creates a Hunters Blowgun
// {1} - ARTIFACT
func NewHuntersBlowgun(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Hunters Blowgun")
	card.ManaCost = "{1}"
