...
func init() {
	cards.Register("Demonic Ruckus", NewDemonicRuckus)
}

// NewDemonicRuckus creates a Demonic Ruckus
// {1}{R} - ENCHANTMENT
func NewDemonicRuckus(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Demonic Ruckus")
	card.ManaCost = "{1}{R}"
