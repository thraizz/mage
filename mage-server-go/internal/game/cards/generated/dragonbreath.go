...
func init() {
	cards.Register("Dragon Breath", NewDragonBreath)
}

// NewDragonBreath creates a Dragon Breath
// {1}{R} - ENCHANTMENT
func NewDragonBreath(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Dragon Breath")
	card.ManaCost = "{1}{R}"
