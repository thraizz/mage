...
func init() {
	cards.Register("Lotus Ring", NewLotusRing)
}

// NewLotusRing creates a Lotus Ring
// {3} - ARTIFACT
// Indestructible
func NewLotusRing(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Lotus Ring")
	card.ManaCost = "{3}"
