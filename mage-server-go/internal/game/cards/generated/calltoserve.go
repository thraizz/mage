...
func init() {
	cards.Register("Call To Serve", NewCallToServe)
}

// NewCallToServe creates a Call To Serve
// {1}{W} - ENCHANTMENT
func NewCallToServe(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Call To Serve")
	card.ManaCost = "{1}{W}"
