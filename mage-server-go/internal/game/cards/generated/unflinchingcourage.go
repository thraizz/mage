...
func init() {
	cards.Register("Unflinching Courage", NewUnflinchingCourage)
}

// NewUnflinchingCourage creates a Unflinching Courage
// {1}{G}{W} - ENCHANTMENT
func NewUnflinchingCourage(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Unflinching Courage")
	card.ManaCost = "{1}{G}{W}"
