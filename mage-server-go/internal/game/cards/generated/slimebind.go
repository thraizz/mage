...
func init() {
	cards.Register("Slimebind", NewSlimebind)
}

// NewSlimebind creates a Slimebind
// {1}{U} - ENCHANTMENT
// Flash
func NewSlimebind(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Slimebind")
	card.ManaCost = "{1}{U}"
