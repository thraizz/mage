...
func init() {
	cards.Register("Relic Bane", NewRelicBane)
}

// NewRelicBane creates a Relic Bane
// {1}{B}{B} - ENCHANTMENT
func NewRelicBane(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Relic Bane")
	card.ManaCost = "{1}{B}{B}"
