...
func init() {
	cards.Register("Roadside Assistance", NewRoadsideAssistance)
}

// NewRoadsideAssistance creates a Roadside Assistance
// {2}{W} - ENCHANTMENT
func NewRoadsideAssistance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Roadside Assistance")
	card.ManaCost = "{2}{W}"
