...
func init() {
	cards.Register("Wind Zendikon", NewWindZendikon)
}

// NewWindZendikon creates a Wind Zendikon
// {U} - ENCHANTMENT
// Flying
func NewWindZendikon(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Wind Zendikon")
	card.ManaCost = "{U}"
