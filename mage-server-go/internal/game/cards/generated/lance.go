...
func init() {
	cards.Register("Lance", NewLance)
}

// NewLance creates a Lance
// {W} - ENCHANTMENT
func NewLance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Lance")
	card.ManaCost = "{W}"
