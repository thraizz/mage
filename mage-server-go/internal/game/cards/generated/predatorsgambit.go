...
func init() {
	cards.Register("Predators Gambit", NewPredatorsGambit)
}

// NewPredatorsGambit creates a Predators Gambit
// {B} - ENCHANTMENT
func NewPredatorsGambit(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Predators Gambit")
	card.ManaCost = "{B}"
