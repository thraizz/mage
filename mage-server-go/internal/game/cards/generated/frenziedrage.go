...
func init() {
	cards.Register("Frenzied Rage", NewFrenziedRage)
}

// NewFrenziedRage creates a Frenzied Rage
// {1}{R} - ENCHANTMENT
func NewFrenziedRage(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Frenzied Rage")
	card.ManaCost = "{1}{R}"
