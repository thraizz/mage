...
func init() {
	cards.Register("Feebleness", NewFeebleness)
}

// NewFeebleness creates a Feebleness
// {1}{B} - ENCHANTMENT
// Flash
func NewFeebleness(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Feebleness")
	card.ManaCost = "{1}{B}"
