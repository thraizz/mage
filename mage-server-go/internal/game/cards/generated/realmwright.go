...
func init() {
	cards.Register("Realmwright", NewRealmwright)
}

// NewRealmwright creates a Realmwright
// {U} - CREATURE
func NewRealmwright(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Realmwright")
	card.ManaCost = "{U}"
