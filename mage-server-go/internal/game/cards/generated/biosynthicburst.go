...
func init() {
	cards.Register("Biosynthic Burst", NewBiosynthicBurst)
}

// NewBiosynthicBurst creates a Biosynthic Burst
// {1}{G} - INSTANT
func NewBiosynthicBurst(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Biosynthic Burst")
	card.ManaCost = "{1}{G}"
