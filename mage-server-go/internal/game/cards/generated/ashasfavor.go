...
func init() {
	cards.Register("Ashas Favor", NewAshasFavor)
}

// NewAshasFavor creates a Ashas Favor
// {2}{W} - ENCHANTMENT
func NewAshasFavor(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Ashas Favor")
	card.ManaCost = "{2}{W}"
