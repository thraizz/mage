...
func init() {
	cards.Register("Alexis Cloak", NewAlexisCloak)
}

// NewAlexisCloak creates a Alexis Cloak
// {1}{U} - ENCHANTMENT
// Flash
func NewAlexisCloak(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Alexis Cloak")
	card.ManaCost = "{1}{U}"
