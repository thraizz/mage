...
func init() {
	cards.Register("Dragon Fangs", NewDragonFangs)
}

// NewDragonFangs creates a Dragon Fangs
// {1}{G} - ENCHANTMENT
func NewDragonFangs(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Dragon Fangs")
	card.ManaCost = "{1}{G}"
