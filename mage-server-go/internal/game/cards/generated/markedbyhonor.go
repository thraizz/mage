...
func init() {
	cards.Register("Marked By Honor", NewMarkedByHonor)
}

// NewMarkedByHonor creates a Marked By Honor
// {3}{W} - ENCHANTMENT
func NewMarkedByHonor(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Marked By Honor")
	card.ManaCost = "{3}{W}"
