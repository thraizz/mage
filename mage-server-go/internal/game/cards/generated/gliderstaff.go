...
func init() {
	cards.Register("Glider Staff", NewGliderStaff)
}

// NewGliderStaff creates a Glider Staff
// {2}{W} - ARTIFACT
func NewGliderStaff(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Glider Staff")
	card.ManaCost = "{2}{W}"
