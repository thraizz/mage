...
func init() {
	cards.Register("Rune Of Might", NewRuneOfMight)
}

// NewRuneOfMight creates a Rune Of Might
// {1}{G} - ENCHANTMENT
func NewRuneOfMight(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Rune Of Might")
	card.ManaCost = "{1}{G}"
