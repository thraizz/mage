...
func init() {
	cards.Register("Brides Gown", NewBridesGown)
}

// NewBridesGown creates a Brides Gown
// {1}{W} - ARTIFACT
func NewBridesGown(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Brides Gown")
	card.ManaCost = "{1}{W}"
