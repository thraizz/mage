...
func init() {
	cards.Register("Grim Reapers Sprint", NewGrimReapersSprint)
}

// NewGrimReapersSprint creates a Grim Reapers Sprint
// {4}{R} - ENCHANTMENT
func NewGrimReapersSprint(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Grim Reapers Sprint")
	card.ManaCost = "{4}{R}"
