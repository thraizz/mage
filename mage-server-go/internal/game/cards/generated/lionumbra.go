...
func init() {
	cards.Register("Lion Umbra", NewLionUmbra)
}

// NewLionUmbra creates a Lion Umbra
// {G}{G} - ENCHANTMENT
func NewLionUmbra(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Lion Umbra")
	card.ManaCost = "{G}{G}"
