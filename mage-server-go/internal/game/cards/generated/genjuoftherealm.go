...
func init() {
	cards.Register("Genju Of The Realm", NewGenjuOfTheRealm)
}

// NewGenjuOfTheRealm creates a Genju Of The Realm
// {W}{U}{B}{R}{G} - ENCHANTMENT
// Trample
func NewGenjuOfTheRealm(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Genju Of The Realm")
