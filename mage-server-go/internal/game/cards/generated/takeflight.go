...
func init() {
	cards.Register("Take Flight", NewTakeFlight)
}

// NewTakeFlight creates a Take Flight
// {3}{U} - ENCHANTMENT
func NewTakeFlight(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Take Flight")
	card.ManaCost = "{3}{U}"
