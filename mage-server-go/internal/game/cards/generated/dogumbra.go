...
func init() {
	cards.Register("Dog Umbra", NewDogUmbra)
}

// NewDogUmbra creates a Dog Umbra
// {1}{W} - ENCHANTMENT
// Flash
func NewDogUmbra(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Dog Umbra")
	card.ManaCost = "{1}{W}"
