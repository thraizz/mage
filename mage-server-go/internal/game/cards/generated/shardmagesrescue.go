...
func init() {
	cards.Register("Shardmages Rescue", NewShardmagesRescue)
}

// NewShardmagesRescue creates a Shardmages Rescue
// {W} - ENCHANTMENT
// Flash
func NewShardmagesRescue(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Shardmages Rescue")
	card.ManaCost = "{W}"
