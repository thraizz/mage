...
func init() {
	cards.Register("Lifelink", NewLifelink)
}

// NewLifelink creates a Lifelink
// {W} - ENCHANTMENT
func NewLifelink(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Lifelink")
	card.ManaCost = "{W}"
