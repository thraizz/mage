...
func init() {
	cards.Register("Torpor Dust", NewTorporDust)
}

// NewTorporDust creates a Torpor Dust
// {2}{U/B} - ENCHANTMENT
// Flash
func NewTorporDust(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Torpor Dust")
	card.ManaCost = "{2}{U/B}"
