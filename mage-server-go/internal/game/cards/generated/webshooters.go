...
func init() {
	cards.Register("Web Shooters", NewWebShooters)
}

// NewWebShooters creates a Web Shooters
// {1}{W} - ARTIFACT
func NewWebShooters(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Web Shooters")
	card.ManaCost = "{1}{W}"
