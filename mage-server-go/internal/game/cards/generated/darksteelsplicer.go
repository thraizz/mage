...
func init() {
	cards.Register("Darksteel Splicer", NewDarksteelSplicer)
}

// NewDarksteelSplicer creates a Darksteel Splicer
// {6}{W} - CREATURE
func NewDarksteelSplicer(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Darksteel Splicer")
	card.ManaCost = "{6}{W}"
