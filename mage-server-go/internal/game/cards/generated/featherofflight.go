...
func init() {
	cards.Register("Feather Of Flight", NewFeatherOfFlight)
}

// NewFeatherOfFlight creates a Feather Of Flight
// {1}{W} - ENCHANTMENT
// Flash
func NewFeatherOfFlight(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Feather Of Flight")
	card.ManaCost = "{1}{W}"
