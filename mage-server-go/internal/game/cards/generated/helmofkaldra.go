...
func init() {
	cards.Register("Helm Of Kaldra", NewHelmOfKaldra)
}

// NewHelmOfKaldra creates a Helm Of Kaldra
// {3} - ARTIFACT
func NewHelmOfKaldra(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Helm Of Kaldra")
	card.ManaCost = "{3}"
