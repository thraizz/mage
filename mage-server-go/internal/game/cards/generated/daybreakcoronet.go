...
func init() {
	cards.Register("Daybreak Coronet", NewDaybreakCoronet)
}

// NewDaybreakCoronet creates a Daybreak Coronet
// {W}{W} - ENCHANTMENT
func NewDaybreakCoronet(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Daybreak Coronet")
	card.ManaCost = "{W}{W}"
