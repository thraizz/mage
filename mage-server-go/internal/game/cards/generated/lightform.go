...
func init() {
	cards.Register("Lightform", NewLightform)
}

// NewLightform creates a Lightform
// {1}{W}{W} - ENCHANTMENT
func NewLightform(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Lightform")
	card.ManaCost = "{1}{W}{W}"
