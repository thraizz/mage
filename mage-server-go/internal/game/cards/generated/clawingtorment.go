...
func init() {
	cards.Register("Clawing Torment", NewClawingTorment)
}

// NewClawingTorment creates a Clawing Torment
// {B} - ENCHANTMENT
func NewClawingTorment(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Clawing Torment")
	card.ManaCost = "{B}"
