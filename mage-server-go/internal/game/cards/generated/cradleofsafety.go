...
func init() {
	cards.Register("Cradle Of Safety", NewCradleOfSafety)
}

// NewCradleOfSafety creates a Cradle Of Safety
// {1}{U} - ENCHANTMENT
// Flash
func NewCradleOfSafety(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Cradle Of Safety")
	card.ManaCost = "{1}{U}"
