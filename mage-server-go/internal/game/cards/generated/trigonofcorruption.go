...
func init() {
	cards.Register("Trigon Of Corruption", NewTrigonOfCorruption)
}

// NewTrigonOfCorruption creates a Trigon Of Corruption
// {4} - ARTIFACT
func NewTrigonOfCorruption(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Trigon Of Corruption")
	card.ManaCost = "{4}"
