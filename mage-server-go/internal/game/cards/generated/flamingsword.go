...
func init() {
	cards.Register("Flaming Sword", NewFlamingSword)
}

// NewFlamingSword creates a Flaming Sword
// {1}{R} - ENCHANTMENT
// Flash
func NewFlamingSword(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Flaming Sword")
	card.ManaCost = "{1}{R}"
