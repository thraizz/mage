...
func init() {
	cards.Register("Raven Wings", NewRavenWings)
}

// NewRavenWings creates a Raven Wings
// {2} - ARTIFACT
func NewRavenWings(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Raven Wings")
	card.ManaCost = "{2}"
