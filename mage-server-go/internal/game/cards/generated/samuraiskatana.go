...
func init() {
	cards.Register("Samurais Katana", NewSamuraisKatana)
}

// NewSamuraisKatana creates a Samurais Katana
// {2}{R} - ARTIFACT
func NewSamuraisKatana(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Samurais Katana")
	card.ManaCost = "{2}{R}"
