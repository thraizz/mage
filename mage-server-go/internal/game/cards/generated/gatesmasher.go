...
func init() {
	cards.Register("Gate Smasher", NewGateSmasher)
}

// NewGateSmasher creates a Gate Smasher
// {3} - ARTIFACT
func NewGateSmasher(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Gate Smasher")
	card.ManaCost = "{3}"
