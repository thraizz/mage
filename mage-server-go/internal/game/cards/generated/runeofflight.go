...
func init() {
	cards.Register("Rune Of Flight", NewRuneOfFlight)
}

// NewRuneOfFlight creates a Rune Of Flight
// {1}{U} - ENCHANTMENT
func NewRuneOfFlight(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Rune Of Flight")
	card.ManaCost = "{1}{U}"
