...
func init() {
	cards.Register("Wings Of Hope", NewWingsOfHope)
}

// NewWingsOfHope creates a Wings Of Hope
// {W}{U} - ENCHANTMENT
func NewWingsOfHope(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Wings Of Hope")
	card.ManaCost = "{W}{U}"
