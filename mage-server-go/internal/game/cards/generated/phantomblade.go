...
func init() {
	cards.Register("Phantom Blade", NewPhantomBlade)
}

// NewPhantomBlade creates a Phantom Blade
// {4}{B} - ARTIFACT
func NewPhantomBlade(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Phantom Blade")
	card.ManaCost = "{4}{B}"
