...
func init() {
	cards.Register("Gimlis Axe", NewGimlisAxe)
}

// NewGimlisAxe creates a Gimlis Axe
// {2}{R} - ARTIFACT
func NewGimlisAxe(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Gimlis Axe")
	card.ManaCost = "{2}{R}"
