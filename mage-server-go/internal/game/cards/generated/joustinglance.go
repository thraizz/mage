...
func init() {
	cards.Register("Jousting Lance", NewJoustingLance)
}

// NewJoustingLance creates a Jousting Lance
// {2} - ARTIFACT
func NewJoustingLance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Jousting Lance")
	card.ManaCost = "{2}"
