...
func init() {
	cards.Register("Messengers Speed", NewMessengersSpeed)
}

// NewMessengersSpeed creates a Messengers Speed
// {R} - ENCHANTMENT
func NewMessengersSpeed(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Messengers Speed")
	card.ManaCost = "{R}"
