...
func init() {
	cards.Register("Howl Of The Hunt", NewHowlOfTheHunt)
}

// NewHowlOfTheHunt creates a Howl Of The Hunt
// {2}{G} - ENCHANTMENT
// Flash
func NewHowlOfTheHunt(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Howl Of The Hunt")
	card.ManaCost = "{2}{G}"
