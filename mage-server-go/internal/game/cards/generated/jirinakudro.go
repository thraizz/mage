...
func init() {
	cards.Register("Jirina Kudro", NewJirinaKudro)
}

// NewJirinaKudro creates a Jirina Kudro
// {1}{R}{W}{B} - CREATURE
func NewJirinaKudro(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Jirina Kudro")
