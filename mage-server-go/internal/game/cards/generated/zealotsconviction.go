...
func init() {
	cards.Register("Zealots Conviction", NewZealotsConviction)
}

// NewZealotsConviction creates a Zealots Conviction
// {W} - ENCHANTMENT
// Flash
func NewZealotsConviction(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Zealots Conviction")
	card.ManaCost = "{W}"
