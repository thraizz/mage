...
func init() {
	cards.Register("Starlit Mantle", NewStarlitMantle)
}

// NewStarlitMantle creates a Starlit Mantle
// {1}{U} - ENCHANTMENT
// Flash
func NewStarlitMantle(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Starlit Mantle")
	card.ManaCost = "{1}{U}"
