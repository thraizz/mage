...
func init() {
	cards.Register("Dragoons Lance", NewDragoonsLance)
}

// NewDragoonsLance creates a Dragoons Lance
// {1}{W} - ARTIFACT
func NewDragoonsLance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Dragoons Lance")
	card.ManaCost = "{1}{W}"
