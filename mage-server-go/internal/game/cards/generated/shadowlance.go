...
func init() {
	cards.Register("Shadow Lance", NewShadowLance)
}

// NewShadowLance creates a Shadow Lance
// {W} - ENCHANTMENT
func NewShadowLance(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Shadow Lance")
	card.ManaCost = "{W}"
