...
func init() {
	cards.Register("Aether Web", NewAetherWeb)
}

// NewAetherWeb creates a Aether Web
// {1}{G} - ENCHANTMENT
// Flash
func NewAetherWeb(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Aether Web")
	card.ManaCost = "{1}{G}"
