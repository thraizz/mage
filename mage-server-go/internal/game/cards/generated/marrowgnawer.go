...
func init() {
	cards.Register("Marrow Gnawer", NewMarrowGnawer)
}

// NewMarrowGnawer creates a Marrow Gnawer
// {3}{B}{B} - CREATURE
func NewMarrowGnawer(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Marrow Gnawer")
	card.ManaCost = "{3}{B}{B}"
