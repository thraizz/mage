...
func init() {
	cards.Register("Face Of Divinity", NewFaceOfDivinity)
}

// NewFaceOfDivinity creates a Face Of Divinity
// {2}{W} - ENCHANTMENT
func NewFaceOfDivinity(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Face Of Divinity")
	card.ManaCost = "{2}{W}"
