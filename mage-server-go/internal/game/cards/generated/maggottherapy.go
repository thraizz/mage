...
func init() {
	cards.Register("Maggot Therapy", NewMaggotTherapy)
}

// NewMaggotTherapy creates a Maggot Therapy
// {2}{B} - ENCHANTMENT
// Flash
func NewMaggotTherapy(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Maggot Therapy")
	card.ManaCost = "{2}{B}"
