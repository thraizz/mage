...
func init() {
	cards.Register("Maul Splicer", NewMaulSplicer)
}

// NewMaulSplicer creates a Maul Splicer
// {6}{G} - CREATURE
func NewMaulSplicer(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Maul Splicer")
	card.ManaCost = "{6}{G}"
