...
func init() {
	cards.Register("No Dachi", NewNoDachi)
}

// NewNoDachi creates a No Dachi
// {2} - ARTIFACT
func NewNoDachi(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "No Dachi")
	card.ManaCost = "{2}"
