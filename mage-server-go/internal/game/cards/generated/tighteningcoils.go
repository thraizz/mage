...
func init() {
	cards.Register("Tightening Coils", NewTighteningCoils)
}

// NewTighteningCoils creates a Tightening Coils
// {1}{U} - ENCHANTMENT
// Flying
func NewTighteningCoils(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Tightening Coils")
	card.ManaCost = "{1}{U}"
