...
func init() {
	cards.Register("Snow Devil", NewSnowDevil)
}

// NewSnowDevil creates a Snow Devil
// {1}{U} - ENCHANTMENT
func NewSnowDevil(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Snow Devil")
	card.ManaCost = "{1}{U}"
