...
func init() {
	cards.Register("Cartouche Of Zeal", NewCartoucheOfZeal)
}

// NewCartoucheOfZeal creates a Cartouche Of Zeal
// {R} - ENCHANTMENT
func NewCartoucheOfZeal(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Cartouche Of Zeal")
	card.ManaCost = "{R}"
