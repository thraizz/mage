...
func init() {
	cards.Register("Gilt Leaf Ambush", NewGiltLeafAmbush)
}

// NewGiltLeafAmbush creates a Gilt Leaf Ambush
// {2}{G} - KINDRED INSTANT
func NewGiltLeafAmbush(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Gilt Leaf Ambush")
	card.ManaCost = "{2}{G}"
