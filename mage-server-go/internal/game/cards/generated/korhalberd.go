...
func init() {
	cards.Register("Kor Halberd", NewKorHalberd)
}

// NewKorHalberd creates a Kor Halberd
// {W} - ARTIFACT
func NewKorHalberd(ownerID uuid.UUID, info *cards.CardInfo) (*game.Card, error) {
	card := game.NewCard(ownerID, "Kor Halberd")
	card.ManaCost = "{W}"
