...
export const AdminGetServerDebugStateRequest: MessageFns<AdminGetServerDebugStateRequest> = {
  ...
  fromPartial(
    object: DeepPartial<AdminGetServerDebugStateRequest>
...
export const AdminGetServerDebugStateResponse: MessageFns<AdminGetServerDebugStateResponse> = {
  ...
  fromJSON(object: any): AdminGetServerDebugStateResponse {
    return {
      memoryActiveGames: isSet(object.memoryActiveGames)
        ? globalThis.Number(object.memoryActiveGames)
        : 0,
      memoryActiveTables: isSet(object.memoryActiveTables)
        ? globalThis.Number(object.memoryActiveTables)
        : 0,
      memoryActiveSessions: isSet(object.memoryActiveSessions)
        ? globalThis.Number(object.memoryActiveSessions)
        : 0,
  ...
  fromPartial(
    object: DeepPartial<AdminGetServerDebugStateResponse>
