...
export const SendDraftCardPickRequest: MessageFns<SendDraftCardPickRequest> = {
  encode(message: SendDraftCardPickRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== "") {
      writer.uint32(10).string(message.sessionId);
    }
    if (message.draftId !== "") {
...
export const SendDraftCardPickResponse: MessageFns<SendDraftCardPickResponse> = {
  encode(message: SendDraftCardPickResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.error !== "") {
...
export const SendDraftCardMarkRequest: MessageFns<SendDraftCardMarkRequest> = {
  encode(message: SendDraftCardMarkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== "") {
      writer.uint32(10).string(message.sessionId);
    }
    if (message.draftId !== "") {
...
export const SendDraftCardMarkResponse: MessageFns<SendDraftCardMarkResponse> = {
  encode(message: SendDraftCardMarkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.error !== "") {
...
export const DraftSetBoosterLoadedRequest: MessageFns<DraftSetBoosterLoadedRequest> = {
  encode(message: DraftSetBoosterLoadedRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== "") {
      writer.uint32(10).string(message.sessionId);
    }
    if (message.draftId !== "") {
...
export const DraftSetBoosterLoadedResponse: MessageFns<DraftSetBoosterLoadedResponse> = {
  encode(message: DraftSetBoosterLoadedResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.error !== "") {
