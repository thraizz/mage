	...
	fromJSON(object: any): GameAssignDamageData {
		return {
			...
			defendingPlayerId: isSet(object.defendingPlayerId)
				...
				: '',
			defendingPlayerName: isSet(object.defendingPlayerName)
				? globalThis.String(object.defendingPlayerName)
				: ''
		};
	},
...
export const GameRollbackRequestData: MessageFns<GameRollbackRequestData> = {
	encode(
		message: GameRollbackRequestData,
		writer: BinaryWriter = new BinaryWriter()
	): BinaryWriter {
	...
	fromJSON(object: any): GameRollbackRequestData {
		return {
			requestingPlayerId: isSet(object.requestingPlayerId)
				? globalThis.String(object.requestingPlayerId)
				: '',
			requestingPlayerName: isSet(object.requestingPlayerName)
				? globalThis.String(object.requestingPlayerName)
				: '',
			targetMessageId: isSet(object.targetMessageId)
				? globalThis.Number(object.targetMessageId)
				: 0,
			targetMessageText: isSet(object.targetMessageText)
				? globalThis.String(object.targetMessageText)
				: '',
...
export const GameRollbackResponseData: MessageFns<GameRollbackResponseData> = {
	encode(
		message: GameRollbackResponseData,
		writer: BinaryWriter = new BinaryWriter()
	): BinaryWriter {
		if (message.requestId !== '') {
	...
	fromJSON(object: any): GameRollbackResponseData {
		return {
			...
			respondingPlayerId: isSet(object.respondingPlayerId)
				? globalThis.String(object.respondingPlayerId)
				: '',
			respondingPlayerName: isSet(object.respondingPlayerName)
				? globalThis.String(object.respondingPlayerName)
				: ''
		};
	},
...
export const GameRollbackCompleteData: MessageFns<GameRollbackCompleteData> = {
	encode(
		message: GameRollbackCompleteData,
		writer: BinaryWriter = new BinaryWriter()
	): BinaryWriter {
		if (message.targetMessageId !== 0) {
	...
	fromJSON(object: any): GameRollbackCompleteData {
		return {
			...
			initiatedByName: isSet(object.initiatedByName)
				? globalThis.String(object.initiatedByName)
				: ''
		};
	},
