...
export enum CallbackMethod {
  ...
  REPLAY_UPDATE = 92,
  REPLAY_DONE = 93,
  /** GAME_ROLLBACK_REQUEST - Rollback Events */
  GAME_ROLLBACK_REQUEST = 100,
  /** GAME_ROLLBACK_RESPONSE - Response to rollback request */
...
export function callbackMethodFromJSON(object: any): CallbackMethod {
  switch (object) {
    ...
    case 100:
    case "GAME_ROLLBACK_REQUEST":
      return CallbackMethod.GAME_ROLLBACK_REQUEST;
    case 101:
    case "GAME_ROLLBACK_RESPONSE":
      return CallbackMethod.GAME_ROLLBACK_RESPONSE;
    case 102:
    case "GAME_ROLLBACK_COMPLETE":
      return CallbackMethod.GAME_ROLLBACK_COMPLETE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function callbackMethodToJSON(object: CallbackMethod): string {
  switch (object) {
    ...
    case CallbackMethod.REPLAY_DONE:
      return "REPLAY_DONE";
    case CallbackMethod.GAME_ROLLBACK_REQUEST:
      return "GAME_ROLLBACK_REQUEST";
    case CallbackMethod.GAME_ROLLBACK_RESPONSE:
      return "GAME_ROLLBACK_RESPONSE";
    case CallbackMethod.GAME_ROLLBACK_COMPLETE:
      return "GAME_ROLLBACK_COMPLETE";
...
export interface GameRollbackRequestData {
...
export interface GameRollbackResponseData {
  requestId: string;
  approved: boolean;
...
export interface GameRollbackCompleteData {
  targetMessageId: number;
  initiatedBy: string;
...
function createBaseGameRollbackRequestData(): GameRollbackRequestData {
  return { requestingPlayerId: "", requestingPlayerName: "", targetMessageId: 0, targetMessageText: "", requestId: "" };
}

export const GameRollbackRequestData: MessageFns<GameRollbackRequestData> = {
  encode(message: GameRollbackRequestData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.requestingPlayerId !== "") {
      writer.uint32(10).string(message.requestingPlayerId);
    }
    if (message.requestingPlayerName !== "") {
      writer.uint32(18).string(message.requestingPlayerName);
    }
    if (message.targetMessageId !== 0) {
      writer.uint32(24).int32(message.targetMessageId);
    }
    if (message.targetMessageText !== "") {
      writer.uint32(34).string(message.targetMessageText);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GameRollbackRequestData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGameRollbackRequestData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.requestingPlayerId = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.requestingPlayerName = reader.string();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.targetMessageId = reader.int32();
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.targetMessageText = reader.string();
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): GameRollbackRequestData {
    return {
      requestingPlayerId: isSet(object.requestingPlayerId) ? globalThis.String(object.requestingPlayerId) : "",
      requestingPlayerName: isSet(object.requestingPlayerName) ? globalThis.String(object.requestingPlayerName) : "",
      targetMessageId: isSet(object.targetMessageId) ? globalThis.Number(object.targetMessageId) : 0,
      targetMessageText: isSet(object.targetMessageText) ? globalThis.String(object.targetMessageText) : "",
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
    };
  },

  toJSON(message: GameRollbackRequestData): unknown {
    const obj: any = {};
    if (message.requestingPlayerId !== "") {
      obj.requestingPlayerId = message.requestingPlayerId;
    }
    if (message.requestingPlayerName !== "") {
      obj.requestingPlayerName = message.requestingPlayerName;
    }
    if (message.targetMessageId !== 0) {
      obj.targetMessageId = Math.round(message.targetMessageId);
    }
    if (message.targetMessageText !== "") {
      obj.targetMessageText = message.targetMessageText;
    }
    if (message.requestId !== "") {
  ...
  create(base?: DeepPartial<GameRollbackRequestData>): GameRollbackRequestData {
    return GameRollbackRequestData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GameRollbackRequestData>): GameRollbackRequestData {
    const message = createBaseGameRollbackRequestData();
    message.requestingPlayerId = object.requestingPlayerId ?? "";
    message.requestingPlayerName = object.requestingPlayerName ?? "";
    message.targetMessageId = object.targetMessageId ?? 0;
    message.targetMessageText = object.targetMessageText ?? "";
    message.requestId = object.requestId ?? "";
    return message;
  },
};

function createBaseGameRollbackResponseData(): GameRollbackResponseData {
  return { requestId: "", approved: false, respondingPlayerId: "", respondingPlayerName: "" };
}

export const GameRollbackResponseData: MessageFns<GameRollbackResponseData> = {
  encode(message: GameRollbackResponseData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.requestId !== "") {
    ...
    if (message.respondingPlayerId !== "") {
      writer.uint32(26).string(message.respondingPlayerId);
    }
    if (message.respondingPlayerName !== "") {
      writer.uint32(34).string(message.respondingPlayerName);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GameRollbackResponseData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGameRollbackResponseData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.respondingPlayerId = reader.string();
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.respondingPlayerName = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GameRollbackResponseData {
    return {
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
      approved: isSet(object.approved) ? globalThis.Boolean(object.approved) : false,
      respondingPlayerId: isSet(object.respondingPlayerId) ? globalThis.String(object.respondingPlayerId) : "",
      respondingPlayerName: isSet(object.respondingPlayerName) ? globalThis.String(object.respondingPlayerName) : "",
    };
  },

  toJSON(message: GameRollbackResponseData): unknown {
    const obj: any = {};
    if (message.requestId !== "") {
      obj.requestId = message.requestId;
    }
    ...
    if (message.respondingPlayerId !== "") {
      obj.respondingPlayerId = message.respondingPlayerId;
    }
    if (message.respondingPlayerName !== "") {
      obj.respondingPlayerName = message.respondingPlayerName;
    }
    return obj;
  },

  create(base?: DeepPartial<GameRollbackResponseData>): GameRollbackResponseData {
    return GameRollbackResponseData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GameRollbackResponseData>): GameRollbackResponseData {
    const message = createBaseGameRollbackResponseData();
    message.requestId = object.requestId ?? "";
    message.approved = object.approved ?? false;
    message.respondingPlayerId = object.respondingPlayerId ?? "";
    message.respondingPlayerName = object.respondingPlayerName ?? "";
    return message;
  },
};

function createBaseGameRollbackCompleteData(): GameRollbackCompleteData {
  return { targetMessageId: 0, initiatedBy: "", initiatedByName: "" };
}

export const GameRollbackCompleteData: MessageFns<GameRollbackCompleteData> = {
  encode(message: GameRollbackCompleteData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.targetMessageId !== 0) {
      writer.uint32(8).int32(message.targetMessageId);
    }
    if (message.initiatedBy !== "") {
      writer.uint32(18).string(message.initiatedBy);
    }
    if (message.initiatedByName !== "") {
      writer.uint32(26).string(message.initiatedByName);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GameRollbackCompleteData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGameRollbackCompleteData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.initiatedByName = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GameRollbackCompleteData {
    return {
      targetMessageId: isSet(object.targetMessageId) ? globalThis.Number(object.targetMessageId) : 0,
      initiatedBy: isSet(object.initiatedBy) ? globalThis.String(object.initiatedBy) : "",
      initiatedByName: isSet(object.initiatedByName) ? globalThis.String(object.initiatedByName) : "",
    };
  },

  toJSON(message: GameRollbackCompleteData): unknown {
    const obj: any = {};
    if (message.targetMessageId !== 0) {
      obj.targetMessageId = Math.round(message.targetMessageId);
    }
    if (message.initiatedBy !== "") {
      obj.initiatedBy = message.initiatedBy;
    }
    if (message.initiatedByName !== "") {
      obj.initiatedByName = message.initiatedByName;
    }
    return obj;
  },

  create(base?: DeepPartial<GameRollbackCompleteData>): GameRollbackCompleteData {
    return GameRollbackCompleteData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GameRollbackCompleteData>): GameRollbackCompleteData {
    const message = createBaseGameRollbackCompleteData();
    message.targetMessageId = object.targetMessageId ?? 0;
    message.initiatedBy = object.initiatedBy ?? "";
    message.initiatedByName = object.initiatedByName ?? "";
    return message;
  },
};
