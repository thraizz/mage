	...
	fromJSON(object: any): GameState {
		return {
			...
			stack: globalThis.Array.isArray(object?.stack)
				? object.stack.map((e: any) => StackItem.fromJSON(e))
				: []
		};
	},
	...
	fromJSON(object: any): Player {
		return {
			...
			hand: globalThis.Array.isArray(object?.hand)
				? object.hand.map((e: any) => Card.fromJSON(e))
				: [],
			graveyard: globalThis.Array.isArray(object?.graveyard)
				? object.graveyard.map((e: any) => Card.fromJSON(e))
				: []
		};
	},
...
export const GameActionRequest: MessageFns<GameActionRequest> = {
	encode(message: GameActionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
		...
		Object.entries(message.parameters).forEach(([key, value]) => {
			GameActionRequest_ParametersEntry.encode(
...
export const GameActionRequest_ParametersEntry: MessageFns<GameActionRequest_ParametersEntry> = {
	encode(
		message: GameActionRequest_ParametersEntry,
...
export const GameActionResponse: MessageFns<GameActionResponse> = {
	...
	fromPartial<I extends Exact<DeepPartial<GameActionResponse>, I>>(object: I): GameActionResponse {
		...
		message.message = object.message ?? '';
		message.newState =
			object.newState !== undefined && object.newState !== null
...
export const GameServiceService = {
	...
	getGameState: {
		...
		requestSerialize: (value: GameStateRequest): Buffer =>
			Buffer.from(GameStateRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GameStateRequest => GameStateRequest.decode(value),
		responseSerialize: (value: GameStateResponse): Buffer =>
			Buffer.from(GameStateResponse.encode(value).finish()),
	...
	streamGameUpdates: {
		...
		requestSerialize: (value: GameStateRequest): Buffer =>
			Buffer.from(GameStateRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GameStateRequest => GameStateRequest.decode(value),
		responseSerialize: (value: GameUpdate): Buffer =>
			Buffer.from(GameUpdate.encode(value).finish()),
	...
	performAction: {
		...
		requestStream: false,
		responseStream: false,
		requestSerialize: (value: GameActionRequest): Buffer =>
			Buffer.from(GameActionRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): GameActionRequest => GameActionRequest.decode(value),
		responseSerialize: (value: GameActionResponse): Buffer =>
			Buffer.from(GameActionResponse.encode(value).finish()),
